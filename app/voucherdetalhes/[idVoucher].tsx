...
export default function VoucherDetalhes() {
  ...
  const { id, nome, status } = route.params as {
    id: number;
    nome: string;
    status: string;
  };
  ...
  return (
    <View style={{ flex: 1, backgroundColor: Cor.base }}>
      ...
      >
        ...
        >
          ...
          <View style={{ width: "100%", padding: 5 }}>
            ...
            >
              Av. R. Nilo Peçanha, 1000 - Centro, Jardim Paulistanos Av. R. Nilo
              Peçanha, 1000 - Centro,
            </Text>
          </View>
      ...
      <Navmenu home={false} calendario={false} controle={false} equipe={false} perfil={false} />
    </View>
  );
}
